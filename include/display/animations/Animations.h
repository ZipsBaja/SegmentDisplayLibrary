...
namespace animations
{
    ...
    namespace onedisplay
    {
        ...
        constexpr ArrayView<uint32_t> anim_looping = make_array_view(frames_looping);
        constexpr ArrayView<uint32_t> anim_fall = make_array_view(frames_fall);
    }
    ...
    namespace twodisplay
    {
        ...
        constexpr ArrayView2D<uint32_t> anim_looping = make_array_view(frames_looping);
    }
